...
rasi_med = st.selectbox("Select RAAS Inhibitor:", ["None", "Enalapril", "Losartan", "Valsartan"], key="rasi_med")
rasi_dose = st.number_input("Enter Daily Dose (mg):", min_value=0, value=0, key="rasi_dose")
